...
Public Class SuperTextBox
    ...
    Public Sub AtualizaTxt(ByVal _texto As String,
        ...
        If Me.Multiline = True Then
            LogaErro(_texto)
            Me.AppendText(_texto & If(bPulaLinha, Environment.NewLine, ""))
    ...
    Public Function AtualizaStatus(ByVal txtTexto As String,
                                   Optional bPulaLinha As Boolean = True) As Boolean
            ...
            With Me
                ...
                If .Multiline Then
                    ...
                    If bPulaLinha = True Then
                        .AppendText(Now.TimeOfDay.Hours.ToString("00") & ":" &
                                    Now.TimeOfDay.Minutes.ToString("00") & ":" &
                                    Now.TimeOfDay.Seconds.ToString("00") & ":" &
                                    Now.TimeOfDay.Milliseconds.ToString("0000") & " - " &
                                    txtTexto.Trim & vbNewLine)
                    Else
                        .AppendText(txtTexto.Trim)
                    End If
